  ...
  <div class="space-y-6">
    ...
    <Collapsible.Root v-model:open="showDebugInfo">
      <div class="bg-bg1 border border-border-2 rounded-lg overflow-hidden">
        <Collapsible.Trigger class="w-full px-6 py-4 border-border-2 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors" 
        :class="{
