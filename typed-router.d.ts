...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/companies/[companyId]': RouteRecordInfo<'/companies/[companyId]', '/companies/:companyId', { companyId: ParamValue<true> }, { companyId: ParamValue<false> }, '/companies/[companyId]/' | '/companies/[companyId]/jobs' | '/companies/[companyId]/products' | '/companies/[companyId]/profile' | '/companies/[companyId]/team' | '/companies/[companyId]/timeline'>,
