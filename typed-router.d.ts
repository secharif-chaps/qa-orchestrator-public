...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/companies': RouteRecordInfo<'/companies', '/companies', Record<never, never>, Record<never, never>, '/companies/(list)' | '/companies/[companyId]' | '/companies/[companyId].jobs' | '/companies/[companyId].products' | '/companies/[companyId].profile' | '/companies/[companyId].team' | '/companies/[companyId].timeline'>,
