...
use App\Application\DocumentQuality\EventListener\TriggerAiValidationAfterQualityEventListener;
...
#[CoversClass(TriggerAiValidationAfterQualityEventListener::class)]
class TriggerAiValidationAfterQualityEventListenerTest extends TestCase
{
    ...
    private TriggerAiValidationAfterQualityEventListener $listener;
    ...
    protected function setUp(): void
    {
        ...
        $this->listener = new TriggerAiValidationAfterQualityEventListener(
...
->method('dispatch');
        ...
        ($this->listener)(new DocumentQualityProcessedEvent(
            documentId: 'doc-1',
            reportId: 'report-1',
            overallScore: 0.1,
            decision: $decision,
