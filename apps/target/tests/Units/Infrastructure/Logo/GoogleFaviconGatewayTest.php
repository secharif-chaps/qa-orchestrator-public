...
use App\Infrastructure\Logo\GoogleFaviconGateway;
...
class GoogleFaviconGatewayTest extends TestCase
{
    private HttpClientInterface&Stub $httpClient;
    private NullLogger $logger;
    private GoogleFaviconGateway $gateway;
    ...
    {
        $this->gateway = new GoogleFaviconGateway($this->httpClient, $this->logger);
    }
