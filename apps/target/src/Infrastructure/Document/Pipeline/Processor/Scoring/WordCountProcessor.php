...
class WordCountProcessor implements PostSaveDocumentProcessorInterface
{
    ...
    {
        return !$context->isHalted && $context->document->hasContent();
    }
    ...
    private function scoreSocialMedia(DocumentPipelineContext $context, int $wordCount): DocumentPipelineContext
    {
    ...
    private function scoreStandard(DocumentPipelineContext $context, int $wordCount): DocumentPipelineContext
    {
