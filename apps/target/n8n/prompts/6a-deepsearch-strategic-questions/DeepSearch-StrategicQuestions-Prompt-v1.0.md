# DeepSearch - Strategic Sub-Questions Decomposition Agent v1.0

## Workflow Information

| Field             | Value                                                             |
| ----------------- | ----------------------------------------------------------------- |
| **Workflow Name** | 6.a DeepSearch - Generate Strategic Question                      |
| **Workflow ID**   | 6RCLmgTzQlBkCBXm                                                  |
| **Node Name**     | LLM_StrategicQuestions_GeneratorAgent                             |
| **LLM Model**     | o4-mini (Primary), gpt-4o-mini (Fallback), Mistral-Small (Parser) |
...
```json
{
  ...
  "type": "object",
  "required": ["subQuestions", "decompositionRationale"],
  "properties": {
    "subQuestions": {
      "type": "array",
      "items": {
        "type": "object",
        "required": ["questionFR", "questionEN", "contextFR", "contextEN", "monitoringDimension", "priority", "expectedOutputType"],
        "properties": {
          "questionFR": {
            "type": "string",
            "minLength": 1
          ...
          "monitoringDimension": {
            "type": "string",
            "enum": ["competitive", "strategic", "commercial", "technological", "regulatory"]
          },
          "priority": {
            "type": "integer",
            "minimum": 0,
    ...
    "decompositionRationale": {
      "type": "object",
      "required": ["approachFR", "approachEN"],
      "properties": {
        "approachFR": {
          "type": "string"
        },
...
| Dimension         | Code            | Focus Areas                                          |
| ----------------- | --------------- | ---------------------------------------------------- |
| **Competitive**   | `competitive`   | Actors, products, positioning, market share          |
| **Strategic**     | `strategic`     | Macro trends, disruptions, sectoral transformations  |
| **Commercial**    | `commercial`    | Business opportunities, purchasing triggers, tenders |
| **Technological** | `technological` | Innovations, patents, standards, R&D                 |
| **Regulatory**    | `regulatory`    | Regulations, standards, compliance, law changes      |
...
| --------------------------- | ------------------------------------------------- |
| **Mutually Exclusive**      | No overlap between sub-questions                  |
| **Collectively Exhaustive** | All critical aspects covered                      |
| **Strategic Focus**         | Each question targets specific investigation axis |
| **Actionable**              | Questions enable concrete information gathering   |
...
| ------- | ---------- | ------------------------------------ |
| v1.0    | 2025-12-15 | Initial extraction from N8N workflow |
