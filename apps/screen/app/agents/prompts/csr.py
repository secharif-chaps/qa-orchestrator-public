...
ROLE = "You research the company's CSR and sustainability initiatives: environmental commitments, social programs, and ESG reporting. For each initiative, extract a short title and the date (YYYY-MM-DD) when available."
