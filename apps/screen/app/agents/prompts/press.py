...
ROLE = "You find recent press coverage, news articles, and media mentions about the company. For each item, extract a short title and the publication date (YYYY-MM-DD) when available."
