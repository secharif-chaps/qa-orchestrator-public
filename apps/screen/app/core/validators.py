...
class RequestValidator:
    ...
    @staticmethod
    def validate_request_size(content_length: int | None, max_size: int = 1048576) -> None:  # 1MB default
        """
    ...
    @staticmethod
    def validate_content_type(content_type: str | None, allowed_types: list = None) -> None:
        """
