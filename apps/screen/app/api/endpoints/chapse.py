...
def get_chapse_service(db: Session = Depends(get_db)) -> ChapseService:
    """Dependency to get ChapseService instance."""
    return ChapseService(db)
...
async def chat(
    ...
    service: ChapseService = Depends(get_chapse_service),
):
    """Send a chat message and stream the response.

    Requires authentication. Streams SSE events from Dify.
    ...
    Args:
        ...
        service: ChapseService instance
    ...
    try:
        ...
        logger.error(f"Dify error in chat: {e}")
...
async def list_conversations(
    ...
    logger.info(
        "List conversations",
        extra={"user_id": user.sub, "limit": limit}
    )
    ...
    try:
        ...
        logger.error(f"Dify error listing conversations: {e}")
...
async def get_conversation(
    ...
    logger.info(
        "Get conversation",
        extra={"user_id": user.sub, "conversation_id": conversation_id}
    )
    ...
    try:
        ...
        logger.error(f"Dify error getting conversation: {e}")
...
async def delete_conversation(
    ...
    Requires authentication. Deletes from Dify and removes context.
    ...
    try:
        ...
        logger.error(f"Dify error deleting conversation: {e}")
...
async def rename_conversation(
    ...
    try:
        ...
        logger.error(f"Dify error renaming conversation: {e}")
