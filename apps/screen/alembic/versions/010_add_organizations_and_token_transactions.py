...
def upgrade() -> None:
    ...
    # Create index on id
    op.create_index("ix_token_transactions_id", "token_transactions", ["id"], unique=False)

    # Create index on organization_id
    op.create_index("ix_token_transactions_organization_id", "token_transactions", ["organization_id"], unique=False)

    # Create composite index on (organization_id, created_at) for efficient history queries
    op.create_index(
        "ix_token_transactions_org_created", "token_transactions", ["organization_id", "created_at"], unique=False
    )
