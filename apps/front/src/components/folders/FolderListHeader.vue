<template>
  <header class="gap-xl flex flex-col sm:flex-row sm:items-center sm:justify-between">
    <div class="gap-xl flex items-center">
      <h1 class="text-neutral-black-font text-2xl font-bold">
        {{ t('common.folder.title', { count: totalCount }) }}
      </h1>
...
const { totalCount = 0 } = defineProps<Props>()
