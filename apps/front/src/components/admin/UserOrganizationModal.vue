<template>
  ...
  >
    <div
      class="border-primary-lighter-stroke mx-4 max-h-[90vh] w-full max-w-168 overflow-y-auto rounded-md border bg-white p-6 shadow-2xl"
    >
      <!-- Header -->
      ...
      <template v-else>
        <!-- User Info -->
        <div class="bg-primary-lightest border-primary-lighter-stroke mb-6 rounded-sm border p-4">
        ...
        <div class="mb-6">
          <h4 class="text-neutral-black-font mb-3 text-sm font-medium">
