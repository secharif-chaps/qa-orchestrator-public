<template>
  <div class="border-primary-lighter-stroke rounded-sm border-2 border-dashed p-4">
    <div class="py-8 text-center">
      <i :class="iconClass" class="text-neutral-black-font mb-3 text-3xl"></i>
      <h3 class="text-neutral-black-font mb-2 text-lg font-semibold">{{ title }}</h3>
      <p class="text-neutral-black-font mb-4">{{ description }}</p>
      <slot name="actions">
        <Button
          v-if="type === 'no-data'"
          variant="primary"
