...
describe('Company types', () => {
  it('should compile with valid type assignments', () => {
    ...
    const mockApiResponse: Company = {
      ...
      products: {
        ...
        marketingPositioning: {
          value: 'Premium luxury positioning',
          source: 'https://lvmh.com/brand',
        },
    ...
    expect(sourcedString).toBeDefined()
    expect(sourcedWithFavicon).toBeDefined()
    expect(sourcedWithTranslation).toBeDefined()
    expect(sourcedNumber).toBeDefined()
    expect(sourcedArray).toBeDefined()
    expect(sourcedObject).toBeDefined()
    expect(pressItem).toBeDefined()
    expect(pressItemWithTranslation).toBeDefined()
    expect(flatMember).toBeDefined()
    expect(memberWithLinkedin).toBeDefined()
    expect(ceoWithHierarchy).toBeDefined()
    expect(companyWithFolder).toBeDefined()
    expect(companyWithRaw).toBeDefined()
  })
})
