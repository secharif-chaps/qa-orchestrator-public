...
describe('Feature flags types', () => {
  it('should compile with valid type assignments', () => {
    // =============================================================================
    ...
    // =============================================================================
    // Verify all variables are defined to prevent unused variable warnings
    // =============================================================================
    expect(discoverFlag).toBeDefined()
    expect(translationFlag).toBeDefined()
    expect(pappersFlag).toBeDefined()
    expect(validFlags).toBeDefined()
    expect(toggleRequestWithoutConfig).toBeDefined()
    expect(toggleRequestWithConfig).toBeDefined()
    expect(toggleRequestWithNullConfig).toBeDefined()
    expect(discoverConfig).toBeDefined()
    expect(hasDiscoverLabelKey).toBeDefined()
    expect(hasDiscoverDescriptionKey).toBeDefined()
    expect(hasDiscoverIcon).toBeDefined()
    expect(featureFlagWithConfig).toBeDefined()
    expect(featureFlagWithoutConfig).toBeDefined()
    expect(discoverDisplayConfig).toBeDefined()
    expect(hasFlag).toBeDefined()
    expect(hasEnabled).toBeDefined()
  })
})
