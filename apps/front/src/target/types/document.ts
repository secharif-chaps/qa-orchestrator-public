...
export type AiValidationStatus = 'pending' | 'validated' | 'rejected' | 'uncertain' | 'failed'
...
export interface DocumentFacets extends FacetsWithValidationStatuses, FacetsWithDomains {}
