      ...
      >
        <div v-if="selectedPreset === 'custom'" class="flex gap-2 items-center">
          <input
            v-model="startDate"
            type="date"
            class="px-3 py-2 text-sm border border-primary-stroke rounded-lg bg-base-100 text-secondary focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
