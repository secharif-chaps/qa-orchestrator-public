          ...
          <tr>
            ...
            >
              <div class="flex items-center gap-1">
                ...
                <i 
                  class="fa text-xs"
                  :class="getSortIcon('workspace_name')"
                ></i>
              </div>
            </th>
            <th 
            ...
            >
              <div class="flex items-center gap-1">
                ...
                <i 
                  class="fa text-xs"
                  :class="getSortIcon('company_count')"
                ></i>
              </div>
            </th>
            <th 
            ...
            >
              <div class="flex items-center gap-1">
                ...
                <i 
                  class="fa text-xs"
                  :class="getSortIcon('avg_cost_per_task')"
                ></i>
              </div>
            </th>
            <th 
            ...
            >
              <div class="flex items-center gap-1">
                ...
                <i 
                  class="fa text-xs"
                  :class="getSortIcon('avg_cost_per_company')"
                ></i>
              </div>
            </th>
          </tr>
