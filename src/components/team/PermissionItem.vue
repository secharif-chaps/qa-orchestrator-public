<template>
  <div
    class="flex items-center justify-between p-4 border border-border-2 rounded-lg transition-all duration-200"
    :class="[
      value ? 'bg-primary/5 border-primary/20' : 'bg-bg1 hover:bg-bg2/50',
  ...
  >
      ...
      <div class="flex items-center gap-3">
        <div class="flex-shrink-0">
          <div 
            ...
            :class="value ? 'bg-primary/10' : 'bg-bg2'"
          >
            <i 
              :class="[
                permission.icon,
    ...
    <div class="flex items-center ml-4">
      <Switch.Root
        ...
        :class="[
          value ? 'bg-primary' : 'bg-bg2 border border-border-2',
        ]"
      >
        <Switch.Thumb
