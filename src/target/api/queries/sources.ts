...
export const SOURCES_QUERY_KEYS = {
  ...
  withFilters: (
    ...
    [
      ...SOURCES_QUERY_KEYS.byWatchFile(watchFileId),
      JSON.stringify(filters),
    ] as const,
  grouped: (watchFileId: string) =>
    [...SOURCES_QUERY_KEYS.root, 'grouped', watchFileId] as const,
  history: (sourceId: string) =>
    [...SOURCES_QUERY_KEYS.root, 'history', sourceId] as const,
  types: (
    watchFileId: string,
...
export const getSourceHistoryQuery = defineQueryOptions(
