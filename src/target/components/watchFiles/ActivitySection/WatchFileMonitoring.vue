<template>
  <div
    class="border-sage-100 flex h-full flex-col rounded-2xl border p-6 shadow-md"
  >
...
const transformActivityToTimelineActivity = (
...
const mapActionTypeToEventType = (actionType: string): WatchFileEventType => {
  const actionTypeMap: Record<string, WatchFileEventType> = {
    ...
    monitoring_type_detected:
      WatchFileEventType.WATCHFILE_MONITORING_TYPE_DETECTED,
    reference_subject_detected:
      WatchFileEventType.WATCHFILE_REFERENCE_SUBJECT_UPDATED,
